...
router.post('/upload', authMiddleware, upload.single('resume'), async (req, res) => {
  try {
    ...
    const newResume = await pool.query(
      'INSERT INTO resumes (user_id, file_name, file_path) VALUES ($1, $2, $3) RETURNING *',
...
// routes/resumes.js — add before module.exports
...
router.delete('/:id', authMiddleware, async (req, res) => {
  ...
  try {
    ...
    // Delete score first (foreign key), then resume
